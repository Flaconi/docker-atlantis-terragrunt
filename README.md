...
make build TERRAFORM=1.10.5 TERRAGRUNT=0.73.11
make build TERRAFORM=1.10.5 TERRAGRUNT=0.73.11 ATLANTIS=0.33.0
make build TERRAFORM=1.10.5 TERRAGRUNT=0.73.11 ATLANTIS=0.33.0 SOPS=3.9.4
```
