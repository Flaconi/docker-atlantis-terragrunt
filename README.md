...
make build TERRAFORM=1.8.0 TERRAGRUNT=0.57.2
make build TERRAFORM=1.8.0 TERRAGRUNT=0.57.2 ATLANTIS=0.27.2
make build TERRAFORM=1.8.0 TERRAGRUNT=0.57.2 ATLANTIS=0.27.2 SOPS=3.8.1
```
