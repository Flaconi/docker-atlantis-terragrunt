...
make build TERRAFORM=1.8.2 TERRAGRUNT=0.57.8
make build TERRAFORM=1.8.2 TERRAGRUNT=0.57.8 ATLANTIS=0.27.2
make build TERRAFORM=1.8.2 TERRAGRUNT=0.57.8 ATLANTIS=0.27.2 SOPS=3.8.1
```
