...
make build TERRAFORM=1.1.7 TERRAGRUNT=0.36.6
make build TERRAFORM=1.1.7 TERRAGRUNT=0.36.6 ATLANTIS=0.19.2
make build TERRAFORM=1.1.7 TERRAGRUNT=0.36.6 ATLANTIS=0.19.2 TERRAGRUNT_ATLANTIS_CONFIG=1.13.0
```
