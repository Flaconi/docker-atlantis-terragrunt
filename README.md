...
make build TERRAFORM=1.6.4 TERRAGRUNT=0.53.3
make build TERRAFORM=1.6.4 TERRAGRUNT=0.53.3 ATLANTIS=0.26.0
make build TERRAFORM=1.6.4 TERRAGRUNT=0.53.3 ATLANTIS=0.26.0 TERRAGRUNT_ATLANTIS_CONFIG=1.16.0
```
