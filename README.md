...
```
make build
make build TERRAFORM=1.5.7
make build TERRAFORM=1.5.7 TERRAGRUNT=0.50.14
make build TERRAFORM=1.5.7 TERRAGRUNT=0.50.14 ATLANTIS=0.25.0
make build TERRAFORM=1.5.7 TERRAGRUNT=0.50.14 ATLANTIS=0.25.0 TERRAGRUNT_ATLANTIS_CONFIG=1.16.0
```
