...
make build TERRAFORM=1.7.5 TERRAGRUNT=0.55.20
make build TERRAFORM=1.7.5 TERRAGRUNT=0.55.20 ATLANTIS=0.27.2
make build TERRAFORM=1.7.5 TERRAGRUNT=0.55.20 ATLANTIS=0.27.2 SOPS=3.8.1
```
