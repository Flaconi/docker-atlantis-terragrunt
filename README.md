...
make build TERRAFORM=1.15.6 TERRAGRUNT=1.0.7
make build TERRAFORM=1.15.6 TERRAGRUNT=1.0.7 ATLANTIS=0.43.0
make build TERRAFORM=1.15.6 TERRAGRUNT=1.0.7 ATLANTIS=0.43.0 SOPS=3.13.0
```
