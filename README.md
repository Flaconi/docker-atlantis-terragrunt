...
make build TERRAFORM=1.2.4 TERRAGRUNT=0.38.4 ATLANTIS=0.19.5
make build TERRAFORM=1.2.4 TERRAGRUNT=0.38.4 ATLANTIS=0.19.5 TERRAGRUNT_ATLANTIS_CONFIG=1.14.2
```
