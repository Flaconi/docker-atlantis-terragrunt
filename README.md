...
```
make build
make build TERRAFORM=1.5.2
make build TERRAFORM=1.5.2 TERRAGRUNT=0.48.0
make build TERRAFORM=1.5.2 TERRAGRUNT=0.48.0 ATLANTIS=0.24.3
make build TERRAFORM=1.5.2 TERRAGRUNT=0.48.0 ATLANTIS=0.24.3 TERRAGRUNT_ATLANTIS_CONFIG=1.16.0
```
