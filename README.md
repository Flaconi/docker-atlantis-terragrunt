...
make build TERRAFORM=1.3.6 TERRAGRUNT=0.42.5 ATLANTIS=0.22.0
make build TERRAFORM=1.3.6 TERRAGRUNT=0.42.5 ATLANTIS=0.22.0 TERRAGRUNT_ATLANTIS_CONFIG=1.16.0
```
