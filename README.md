...
```
make build
make build TERRAFORM=1.6.2
make build TERRAFORM=1.6.2 TERRAGRUNT=0.52.3
make build TERRAFORM=1.6.2 TERRAGRUNT=0.52.3 ATLANTIS=0.26.0
make build TERRAFORM=1.6.2 TERRAGRUNT=0.52.3 ATLANTIS=0.26.0 TERRAGRUNT_ATLANTIS_CONFIG=1.16.0
```
