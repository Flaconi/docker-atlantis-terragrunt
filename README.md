...
make build TERRAFORM=1.5.7 TERRAGRUNT=0.51.6
make build TERRAFORM=1.5.7 TERRAGRUNT=0.51.6 ATLANTIS=0.25.0
make build TERRAFORM=1.5.7 TERRAGRUNT=0.51.6 ATLANTIS=0.25.0 TERRAGRUNT_ATLANTIS_CONFIG=1.16.0
```
