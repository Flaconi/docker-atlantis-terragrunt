...
make build TERRAFORM=1.5.5 TERRAGRUNT=0.50.4
make build TERRAFORM=1.5.5 TERRAGRUNT=0.50.4 ATLANTIS=0.25.0
make build TERRAFORM=1.5.5 TERRAGRUNT=0.50.4 ATLANTIS=0.25.0 TERRAGRUNT_ATLANTIS_CONFIG=1.16.0
```
